...
public class ProductServiceImplTests {
    ...
    @Test
    @Transactional
    public void shouldSetQuantityOneWhileProductIsSavedBecauseAcustomerCanBuyAlwaysAtLeastOneProduct() throws Exception {
        // given
        final int databaseSizeBeforeSave = productRepository.findAll().size();
    ...
    public void shouldFindProductById() throws Exception {
        ...
        assertThat(testProduct.get().getProductCategoryEnum()).isEqualTo(product.getProductCategoryEnum());
