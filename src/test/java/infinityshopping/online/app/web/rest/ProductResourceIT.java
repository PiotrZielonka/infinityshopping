...
class ProductResourceIT {
    ...
    void getNonExistingProduct() throws Exception {
        // Get the product
        restProductMockMvc.perform(get(ENTITY_API_URL + "/byid/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteProductByUserShouldThrowStatusForbidden() throws Exception {
        ...
        ProductDTO productDto = productMapper.toDto(product);
        restProductMockMvc
            .perform(delete(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(productDto)))
            .andExpect(status().isForbidden());
